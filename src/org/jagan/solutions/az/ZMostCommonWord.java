...
public class ZMostCommonWord {
	 ...
	 *
	 * Explanation:
	 * "hit" occurs 3 times, but it is a banned word. "ball" occurs twice
	 * (and no other word does), so it is the most frequent non-banned word in
	 ...
	 *
	 * Note:
	 * 1 <= paragraph.length <= 1000. 0 <= banned.length <= 100.
	 * 1 <= banned[i].length <= 10.
	 * The answer is unique, and written in lowercase (even if its occurrences in
	 * paragraph may have uppercase symbols, and even if it is a proper noun.)
	 * paragraph only consists of letters, spaces, or the punctuation symbols !?',;.
	 * There are no hyphens or hyphenated words. Words only consist of letters,
	...
	public static void main(String[] args) {
		...
		String[] banned = {"hit"};
		String mostCommonWord = mostCommonWord(input, banned);
		System.out.println("Most Command Word : " + mostCommonWord);
		Assertions.assertEquals("ball", mostCommonWord, "Incorrect most common word...");
	}
